!(function (t) {
  ...
  function (t, e, i) {
    if ((i(1), "undefined" == typeof AFRAME))
      throw new Error(
    ...
    AFRAME.registerComponent("tooltip", {
      ...
      init: function () {
        var t = this.el,
          e = this.data,
          i = (this.quad = document.createElement("a-entity")),
          a = this;
        i.addEventListener("loaded", function () {
          a.updateTooltip();
        }),
          i.setAttribute("slice9", {
            width: e.width,
            height: e.height,
            left: 20,
            right: 43,
          ...
          i.setAttribute("rotation", e.rotation),
          i.setAttribute("text", {
            width: 0.25,
            color: "#fff",
            value: e.text,
          ...
          t.appendChild(i);
        var r = (this.material = new THREE.LineBasicMaterial({
            color: e.lineColor,
            opacity: e.opacity,
            transparent: e.opacity < 1,
          })),
          o = (this.geometry = new THREE.BufferGeometry());
        o.addAttribute(
          "position",
          new THREE.BufferAttribute(new Float32Array(6), 3)
        ),
          (this.line = new THREE.Line(o, r)),
      ...
      updateTooltip: (function () {
        ...
        return function () {
          var a = this.data;
          t.copy(this.el.getAttribute("position")), e.copy(a.targetPosition);
          var r = e.sub(t),
            a = this.data,
            o = { top: a.height / 2, bottom: -a.height / 2, center: 0 },
            n = { left: -a.width / 2, right: a.width / 2, center: 0 },
            s = o[a.lineVerticalAlign],
            l = n[a.lineHorizontalAlign];
          this.quad.setAttribute("slice9", { opacity: a.opacity }),
            this.quad.setAttribute("text", {
              opacity: a.opacity,
              value: a.text,
            }),
            this.quad.object3D.updateMatrix(),
            i.set(l, s, 0),
            i.applyMatrix4(this.quad.object3D.matrix);
          var d = this.geometry.attributes.position.array;
          (d[0] = i.x),
            (d[1] = i.y),
            (d[2] = i.z),
            (d[3] = r.x),
            ...
            (this.material.transparent = a.opacity < 1),
    ...
    AFRAME.registerComponent("slice9", {
      ...
      init: function () {
        var t = this.data,
          ...
          i = (this.geometry = new THREE.PlaneGeometry(
            t.width,
            t.height,
            3,
            3
